    ...
    namespace Property
    {
      ...
      class CrystalPreferredOrientation : public Interface<dim>, public ::aspect::SimulatorAccess<dim>
      {
        public:
          ...
          {
            return static_cast<DeformationType>(data[cpo_data_position + 0 + mineral_i * (n_grains * 28 + 2)]);
          }
          ...
          {
            data[cpo_data_position + 0 + mineral_i * (n_grains * 28 + 2)] = static_cast<double>(deformation_type);
          }
          ...
          {
            data[cpo_data_position + 1 + mineral_i *(n_grains * 28 + 2)] = volume_fraction_mineral;
          }
          ...
          {
            return data[cpo_data_position + 2 + grain_i * 28 + mineral_i * (n_grains * 28 + 2)];
          }
          ...
          {
            data[cpo_data_position + 2 + grain_i * 28 + mineral_i * (n_grains * 28 + 2)] = volume_fractions_grains;
          }
            ...
            for (unsigned int i = 0; i < Tensor<2,3>::n_independent_components ; ++i)
              {
                ...
                rotation_matrix[index] = data[cpo_data_position + 3 + grain_i * 28 + mineral_i * (n_grains * 28 + 2) + i];
              }
                                          ...
                                          const Tensor<2,3> &rotation_matrix) const
          {
            for (unsigned int i = 0; i < Tensor<2,3>::n_independent_components ; ++i)
              {
                const dealii::TableIndices<2> index = Tensor<2,3>::unrolled_to_component_indices(i);
                data[cpo_data_position + 3 + grain_i * 28 + mineral_i * (n_grains * 28 + 2) + i] = rotation_matrix[index];
              }
          }
          ...
          int get_grain_status(const unsigned int cpo_data_position,
                                             ...
                                             const unsigned int grain_i) const
          {
            return data[cpo_data_position + 12 + grain_i * 28 + mineral_i * (n_grains * 28 + 2)];
          }
          ...
          {
            data[cpo_data_position + 12 + grain_i * 28 + mineral_i * (n_grains * 28 + 2)] = grain_status;
          }
          ...
          double get_strain_accumulated(const unsigned int cpo_data_position,
                                             ...
                                             const unsigned int grain_i) const
          {
            return data[cpo_data_position + 13 + grain_i * 28 + mineral_i * (n_grains * 28 + 2)];
          }
          ...
          {
            data[cpo_data_position + 13 + grain_i * 28 + mineral_i * (n_grains * 28 + 2)] = strain_accumulated;
          }
          ...
          double get_rx_fractions(const unsigned int cpo_data_position,
                                             ...
                                             const unsigned int grain_i) const
          {
            return data[cpo_data_position + 14 + grain_i * 28 + mineral_i * (n_grains * 28 + 2)];
          }
          ...
          {
            data[cpo_data_position + 14 + grain_i * 28 + mineral_i * (n_grains * 28 + 2)] = rx_fractions;
          }
          ...
          int get_active_slip_system(const unsigned int cpo_data_position,
                                             ...
                                             const unsigned int grain_i) const
          {
            return data[cpo_data_position + 15 + grain_i * 28 + mineral_i * (n_grains * 28 + 2)];
          }
          ...
          {
            data[cpo_data_position + 15 + grain_i * 28 + mineral_i * (n_grains * 28 + 2)] = active_slip_system;
          }
          ...
          double get_strain_rate(const unsigned int cpo_data_position,
                                             ...
                                             const unsigned int grain_i) const
          {
            return data[cpo_data_position + 16 + grain_i * 28 + mineral_i * (n_grains * 28 + 2)];
          }
          ...
          {
            data[cpo_data_position + 16 + grain_i * 28 + mineral_i * (n_grains * 28 + 2)] = strain_rate;
          }
          ...
          double get_differential_stress(const unsigned int cpo_data_position,
                                             ...
                                             const unsigned int grain_i) const
          {
            return data[cpo_data_position + 17 + grain_i * 28 + mineral_i * (n_grains * 28 + 2)];
          }
          ...
          {
            data[cpo_data_position + 17 + grain_i * 28 + mineral_i * (n_grains * 28 + 2)] = differential_stress;
          }
          ...
          double get_strain_energy(const unsigned int cpo_data_position,
                                             ...
                                             const unsigned int grain_i) const
          {
            return data[cpo_data_position + 18 + grain_i * 28 + mineral_i * (n_grains * 28 + 2)];
          }
          ...
          {
            data[cpo_data_position + 18 + grain_i * 28 + mineral_i * (n_grains * 28 + 2)] = strain_energy;
          }
          ...
          double get_surface_energy(const unsigned int cpo_data_position,
                                             ...
                                             const unsigned int grain_i) const
          {
            return data[cpo_data_position + 19 + grain_i * 28 + mineral_i * (n_grains * 28 + 2)];
          }
          ...
          {
            data[cpo_data_position + 19 + grain_i * 28 + mineral_i * (n_grains * 28 + 2)] = surface_energy;
          }
          ...
          double get_grain_boundary_velocity(const unsigned int cpo_data_position,
                                             ...
                                             const unsigned int grain_i) const
          {
            return data[cpo_data_position + 20 + grain_i * 28 + mineral_i * (n_grains * 28 + 2)];
          }
          ...
          {
            data[cpo_data_position + 20 + grain_i * 28 + mineral_i * (n_grains * 28 + 2)] = grain_boundary_velocity;
          }          
          ...
          int get_n_rx_grains(const unsigned int cpo_data_position,
                                             ...
                                             const unsigned int grain_i) const
          {
            return data[cpo_data_position + 21 + grain_i * 28 + mineral_i * (n_grains * 28 + 2)];
          }
          ...
          {
            data[cpo_data_position + 21 + grain_i * 28 + mineral_i * (n_grains * 28 + 2)] = n_rx_grains;
          }
           ...
           */
           ...
           double get_pre_rx_size(const unsigned int cpo_data_position,
                                              ...
                                              const unsigned int grain_i) const
           {
             return data[cpo_data_position + 22 + grain_i * 28 + mineral_i * (n_grains * 28 + 2)];
           }
           ...
           {
             data[cpo_data_position + 22 + grain_i * 28 + mineral_i * (n_grains * 28 + 2)] = pre_rx_size;
           }
           ...
           */
           ...
           double get_post_rx_size(const unsigned int cpo_data_position,
                                              ...
                                              const unsigned int grain_i) const
           {
             return data[cpo_data_position + 23 + grain_i * 28 + mineral_i * (n_grains * 28 + 2)];
           }
           ...
           {
             data[cpo_data_position + 23 + grain_i * 28 + mineral_i * (n_grains * 28 + 2)] = post_rx_size;
           }
           ...
           */
           ...
           double get_grain_size_change(const unsigned int cpo_data_position,
                                              ...
                                              const unsigned int grain_i) const
           {
             return data[cpo_data_position + 24 + grain_i * 28 + mineral_i * (n_grains * 28 + 2)];
           }
           ...
           {
             data[cpo_data_position + 24 + grain_i * 28 + mineral_i * (n_grains * 28 + 2)] = grain_size_change;
           }
           ...
           double get_dislocation_density(const unsigned int cpo_data_position,
                                              ...
                                              const unsigned int grain_i) const
           {
             return data[cpo_data_position + 25 + grain_i * 28 + mineral_i * (n_grains * 28 + 2)];
           }
           ...
           {
             data[cpo_data_position + 25 + grain_i * 28 + mineral_i * (n_grains * 28 + 2)] = dislocation_density;
           }
                                              ...
                                              const unsigned int grain_i) const
           {
            ...
            for (unsigned int i = 0; i < 4; ++i)
              {
                slip_activity[i] =  data[cpo_data_position + 26 + grain_i * 28 + mineral_i * (n_grains * 28 + 2) + i];
              }
                                            ...
                                            const  std::array<double,4> slip_activity) const
           {
            ...
            {
              data[cpo_data_position + 26 + grain_i * 28 + mineral_i * (n_grains * 28 + 2) +slip_system_i] = slip_activity[slip_system_i];
            }
           }
