  ...
  namespace Postprocess
  {
    ...
    class CrystalPreferredOrientation : public Interface<dim>, public ::aspect::SimulatorAccess<dim>
    {
      ...
      private:
        ...
        enum class Output
        {
          VolumeFraction, RotationMatrix, EulerAngles, GrainStatus, StrainrateRatio, RxFraction, ActiveSS, StrainRate, DifferentialStress, StrainEnergy, SurfaceEnergy, GrainSizeChange, DislocationDensity, StrainAccumulated, StiffnesRatio, ODETimescale, ADrive, MisAngle, RotAxis, RotRate, PhiAngle, PostRXSize, not_found
        };
