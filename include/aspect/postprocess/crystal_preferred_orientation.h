  ...
  namespace Postprocess
  {
    ...
    class CrystalPreferredOrientation : public Interface<dim>, public ::aspect::SimulatorAccess<dim>
    {
      ...
      private:
        ...
        enum class Output
        {
          VolumeFraction, RotationMatrix, EulerAngles, GrainStatus, StrainrateRatio, ViscosityRatio, RxFraction, ActiveSS, StrainRate, DifferentialStress, StrainEnergy, SurfaceEnergy, GBMVelocity, GrainSizeChange, DislocationDensity, StrainAccumulated, EnergyRatio, Omega, Gamma, not_found
        };
